...
class BuatAkunView extends GetView<BuatAkunController> {
  const BuatAkunView({Key? key}) : super(key: key);
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    borderSide: BorderSide(
                        color: Color(0xFFD7D0C3),
                        width: 2), // Slightly darker border color
                    borderRadius: BorderRadius.circular(10.0),
                  ),
                  focusedBorder: OutlineInputBorder(
                    borderSide: BorderSide(
                        color: Color(0xFFA4907C),
                        width: 1.5), // Slightly darker border color
                    borderRadius: BorderRadius.circular(10.0),
                  ),
                ),
              ),
